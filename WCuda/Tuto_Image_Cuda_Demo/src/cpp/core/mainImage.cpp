...
int mainImage(Settings& settings)
    ...
    Viewer<RipplingProvider> rippling(zoomable, 0, 0); // imageOption px py
    Viewer<MandelbrotProvider> mandelbrot(zoomable, 400, 0); // imageOption px py
    Viewer<RayTracingProvider> raytracing(zoomable, 800, 0); // imageOption px py
    // Common
